...
import com.almissbah.revoluttest.databinding.CurrenciesFragmentBinding
import com.almissbah.revoluttest.ui.BaseFragment
import com.almissbah.revoluttest.ui.main.CurrenciesAdapter.ItemClickListener
...
class CurrenciesFragment : BaseFragment() {
    ...
    private fun initCurrenciesView() {
        ...
        currenciesAdapter.textChangeListener = object : CurrenciesAdapter.TextChangeListener {
